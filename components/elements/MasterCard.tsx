...
export function MasterCard() {
    return (
        <div className="w-screen h-[calc(100vh-120px)] p-8 flex flex-col justify-center items-center">

                <Title title="bleh" />

                <div className="flex flex-wrap justify-center h-[75%] max-sm:h-[50%] gap-5 max-sm:gap-1 mx-auto overflow-y-auto drop-shadow-2xl [column-fill:_balance] sm:columns-2 sm:gap-6 lg:columns-3 lg:gap-8">
                    <div className="sm:break-inside-avoid border w-96">
